            ...
            <input type="hidden" name="form-name" value="contactForm" />
              <fieldset>
                <div>
                  ...
                  <input type="text" defaultValue size={35} id="contactName" name="contactName" defaultValue={"Name"}  required/>
                </div>
                <div>
                  <label htmlFor="contactEmail">Email <span className="required">*</span></label>
                  <input type="email" defaultValue size={35} id="contactEmail" name="contactEmail" defaultValue={"Email"}  required/>
                </div>
                <div>
                  <label htmlFor="contactSubject">Subject</label>
                  <input type="text" defaultValue size={35} id="contactSubject" name="contactSubject"  defaultValue={"Subject"}/>
                </div>
                <div>
                  <label htmlFor="contactMessage">Message <span className="required">*</span></label>
                  <textarea cols={50} rows={5} id="contactMessage" name="contactMessage" defaultValue={""} required/>
                </div>
                <div>
